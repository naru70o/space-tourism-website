...
export default function Home() {
  return (
    <div className="grid grid-cols-12 h-screen image">
      <div className="grid col-start-1 col-span-12 grid-cols-subgrid flex-col overflow-hidden mt-0 px-[2.4rem] md:px-[0rem] text-white xl:pt-8 w-full">
        ...
        <div className="col-start-2 col-span-10">
          <div className="flex flex-col xl:flex-row gap-[1.6rem] justify-between items-center max-w-[122.8rem] xl:mx-auto mt-[2.4rem] md:mt-[1rem] h-full py-6">
